				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="工商注册号" prop="businessLicense">
							<el-input v-model="form.businessLicense" placeholder="请输入公司工商注册号" maxlength="30" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
...
import { listCompany, addCompany, getCompany, delCompany, updateCompany } from "@/api/admin/company/info";
...
function getList() {
	loading.value = true;
	listCompany(queryParams.value).then((res: any) => {
		loading.value = false;
		console.log(res);
