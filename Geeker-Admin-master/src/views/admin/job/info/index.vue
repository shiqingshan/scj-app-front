<template>
	<div class="app-container">
		<el-table v-loading="loading" :data="companyList">
			...
			<el-table-column prop="status" label="发布状态" width="160">
			...
			<el-table-column label="操作" align="center" class-name="small-padding fixed-width">
				<template #default="scope">
					<el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)">修改状态</el-button>
		...
		<el-dialog v-model="open" :title="title" width="600px" append-to-body>
			<el-form ref="jobInfoRef" :model="form" :rules="rules" label-width="120px">
				<el-row>
					<el-col :span="24">
						<el-form-item label="招聘企业" prop="coName">
							<el-input disabled v-model="form.coName" placeholder="请输入企业" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="12">
						<el-form-item label="职位名称" prop="jobName">
							<el-input disabled v-model="form.jobName" placeholder="请输入职位名称" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
import { listJobInfo, getJobInfo, delJobInfo, updateJobInfo } from "@/api/admin/job/info";
