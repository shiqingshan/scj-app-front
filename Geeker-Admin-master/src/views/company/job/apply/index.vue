<template>
	<div>
		<el-table v-loading="loading" :data="companyList">
			...
			<el-table-column label="申请日期" align="center" prop="applyDate" width="200">
				<template #default="scope">
		...
		<el-dialog v-model="open" :title="title" width="600px" append-to-body>
			<el-form ref="jobApplyRef" :model="form" :rules="rules" label-width="120px">
				<el-row>
					<el-col :span="12">
						<el-form-item label="申请用户" prop="userInfo.userName">
						...
						<el-form-item label="申请职位名称" prop="jobInfo.jobName">
							<el-input v-model="form.jobInfo.jobName" disabled placeholder="申请职位名称" maxlength="30" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="12">
						<el-form-item label="简历附件" prop="resumeFileId">
							<el-input v-model="form.resumeFileId" disabled placeholder="请输入公司名称" maxlength="30" />
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="12">
						<el-form-item label="面试日期" prop="interviewDate">
							<el-date-picker v-model="form.interviewDate" type="date" placeholder="请选择面试日期" size="default" />
						</el-form-item>
						<el-form-item label="面试地点" prop="interviewLocation">
							<el-input v-model="form.interviewLocation" placeholder="请输入面试地点" maxlength="30" />
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
			<template #footer>
				<div class="dialog-footer">
					<el-button type="primary" @click="submitForm">邀请面试</el-button>
...
import { listCompanyApply, getApply, addInterview } from "@/api/app/apply";
...
function getList() {
	loading.value = true;
	listCompanyApply(queryParams.value).then((res: any) => {
		loading.value = false;
		console.log(res);
