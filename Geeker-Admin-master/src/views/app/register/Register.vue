		...
		<div>
			<div class="register">
				<div class="register-title">
					<h1 v-show="accountType === '0'">学生注册</h1>
					<h1 v-show="accountType === '1'">企业注册</h1>
				</div>
					...
					<el-form ref="registerFormRef" :model="form" :rules="rules" label-width="130px">
						...
						<div v-if="accountType === '2'">
							...
							<el-form-item
								label="企业地址："
								prop="companyAddress"
								:rules="[{ required: true, message: '企业地址不能为空！', trigger: 'blur' }]"
							>
							...
							<el-form-item
								label="企业联系人："
								prop="contact"
								:rules="[{ required: true, message: '企业联系人不能为空！', trigger: 'blur' }]"
							>
							...
							<el-form-item
								label="企业联系人电话："
								prop="contactPhone"
								:rules="[{ required: true, message: '企业联系人电话不能为空！', trigger: 'blur' }]"
							>
